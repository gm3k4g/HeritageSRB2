...
static boolean P_CheckMissileRange (mobj_t* actor)
{
	...
	if (actor->type == MT_EGGMOBILE) // Tails 09-03-2001
		dist >>= 1;
...
void A_BossDeath (mobj_t* mo)
{
	...
	// Tails who cares what level or what enemy? If the function is called, LET IT RUN!
...
{
	// Lactozilla: Someone commented out the actual part
	// that assings MT_BOSSTARGET to braintargets, for some reason,
	// so I just removed the entire iterator
