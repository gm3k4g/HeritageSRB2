...
UINT8*           ylookup[MAXVIDHEIGHT];

UINT8*           ylookup1[MAXVIDHEIGHT]; // for view1 (splitscreen)
UINT8*           ylookup2[MAXVIDHEIGHT]; // for view2 (splitscreen)
