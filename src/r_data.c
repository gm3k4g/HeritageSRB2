...
//
UINT8* R_GenerateTexture (int texnum)
{
    UINT8*               block;
    UINT8*               blocktex;
    texture_t*          texture;
...
UINT8* R_GetFlat (int  flatlumpnum)
{
...
/*  // this code don't work because it don't put a proper user in the z_block
    ...
    data = (UINT8 *) W_CacheLumpNum(flatlumpnum,PU_LEVEL);
    ...
    //flatcache[flatlumpnum] =(UINT8*) wput;
