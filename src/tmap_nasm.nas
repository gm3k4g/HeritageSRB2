...
;----------------------------------------------------------------------------
[GLOBAL _ASM_PatchRowBytes_NASM]
;       align   16
_ASM_PatchRowBytes_NASM:
        mov     eax,[esp+4]
        mov     [rowbytes],eax
        add     eax,eax
...
[GLOBAL _R_DrawColumn_8_NASM]
;       align   16
_R_DrawColumn_8_NASM:
...
[GLOBAL _R_DrawSkyColumn_8_NASM]
;       align   16
_R_DrawSkyColumn_8_NASM:
        push    ebp
        push    esi
        push    edi
        push    ebx
...
[GLOBAL _R_DrawTranslucentColumn_8_NASM]
_R_DrawTranslucentColumn_8_NASM:
        push    ebp                     ;; preserve caller's stack frame pointer
        push    esi                     ;; preserve register variables
        push    edi
        push    ebx
...
;;   for smoke..etc.. test.
;;----------------------------------------------------------------------
[GLOBAL _R_DrawShadeColumn_8_NASM]
_R_DrawShadeColumn_8_NASM:
        push    ebp                     ;; preserve caller's stack frame pointer
        push    esi                     ;; preserve register variables
        push    edi
        push    ebx
