...
// -------------------------------
extern UINT8*            ylookup[MAXVIDHEIGHT];
extern UINT8*            ylookup1[MAXVIDHEIGHT];
extern UINT8*            ylookup2[MAXVIDHEIGHT];
extern int              columnofs[MAXVIDWIDTH];

#ifdef HORIZONTALDRAW
//Fab 17-06-98
extern UINT8*            yhlookup[MAXVIDWIDTH];
...
extern UINT8*            transtables;    // translucency tables
extern UINT8*            dc_transmap;

// translation stuff here

extern UINT8*            translationtables;
