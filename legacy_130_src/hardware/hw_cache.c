...
extern UINT8 transtables[256][256];
...
static void HWR_DrawPatchInCache (UINT8* block,
								  int   blockwidth,
								  int   blockheight,
								  int   blockmodulo,
								  int   texturewidth,
...
//       blockwidth
//       blockheight
//note :  8bit (1 UINT8 per pixel) palettized format
...
// -------------------+
void HWR_GetMappedPatch(GlidePatch_t* gpatch, UINT8 *colormap)
{
